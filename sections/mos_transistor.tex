...
\begin{minipage}{10cm}
	...
	{ \centering 
	\adjustbox{scale=0.5}{\input{tikz/ersatzschaltbild_widerstandsbetrieb}}
	\hspace{5mm}
	\adjustbox{scale=0.5}{\input{tikz/ersatzschaltbild_stromquellenbetrieb}}
	}
...
{	\centering
		\adjustbox{scale=0.8}{\input{tikz/transferkennlinien}}
	\qquad\qquad
