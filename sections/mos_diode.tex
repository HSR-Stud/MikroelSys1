...
\begin{figure}[h]
	...
	\begin{subfigure}[b]{4cm}
		\centering
		{\input{tikz/diode_nmos}}
		\caption{n-Kanal}
	\end{subfigure}
	\begin{subfigure}[b]{4cm}
		\centering
		{\input{tikz/diode_pmos}}
		\caption{p-Kanal}
	\end{subfigure}
	\hspace{1.5cm}
	
	\begin{subfigure}[b]{4cm}
		{\input{tikz/kennlinie_diode_ideal}}
	\end{subfigure} \quad
	\begin{subfigure}[b]{4cm}
		\centering
		{\input{tikz/kennlinie_diode_real}}
	\end{subfigure} \qquad
	\begin{subfigure}[b]{8cm}
		\centering
		{\input{tikz/kennlinie_diode_mos}}
	\end{subfigure}			
